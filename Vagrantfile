...
#Vagrant.configure("2") do |config|
  #config.vm.define "ubuntu" do |cofig|
  ...
  #config.vm.box = "ubuntu/trusty64"
    ...
    #ubuntu.vm.hostname = "ubuntu-prathmesh"
    #ubuntu.vm.network "public_network", bridges: "en0: Wi-Fi (AirPort)", type: "dhcp"
...
#Configuring Centos
  config.vm.define "centos" do |centos|
    ...
    centos.vm.hostname = "centos-prathmesh"
